    ...
    public ResponseEntity<StartupOpt> createStartupOpt(@RequestBody StartupOpt startupOpt) {
        try {
            StartupOpt _startupOpt = startupOptService
                    .addSStartupOpt(new StartupOpt(startupOpt.getTitle(), startupOpt.getProvider(), startupOpt.getDescription(), startupOpt.getStartDate(), startupOpt.getEndDate(), startupOpt.getWebsite(), startupOpt.getCategories(), startupOpt.getSupportCategories()));
